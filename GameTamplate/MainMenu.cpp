...
void MainMenu::onStateEnter() {
	...
	_title = new TextRenderer(glm::vec2(20, 580), new Sprite("Sprites/font.png", glm::vec2(64), 1, glm::vec2(15, 8), true), 54, 32);
	...
	_buttons[3]->setEvent("HighScore");
	_buttons[4]->setEvent("Quit");
}
